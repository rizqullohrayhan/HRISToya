...
return new class extends Migration
{
    ...
    {
        Schema::create('surat_ijins', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreignId('status_id')->nullable()->references('id')->on('status_surat_ijins')->onDelete('SET NULL');
    ...
    {
        Schema::dropIfExists('surat_ijins');
    }
};
