                    ...
                    <div class="card-body">
                        <form action="{{ route('kantor.update', $kantor->id) }}" method="post">
                            ...
                            <div class="form-group @error('name') has-error @enderror">
                                ...
                                <input type="text" class="form-control" name="name" value="{{ old('name', $kantor->name) }}"/>
                                @error('name')
                            ...
                            <div class="form-group @error('latitude') has-error @enderror">
                                ...
                                <input type="text" class="form-control" name="latitude" value="{{ old('latitude', $kantor->latitude) }}"/>
                                @error('latitude')
                                <small class="form-text text-muted">
                                    {{ $message }}
                                </small>
                            ...
                            <div class="form-group @error('longitude') has-error @enderror">
                                ...
                                <input type="text" class="form-control" name="longitude" value="{{ old('longitude', $kantor->longitude) }}"/>
                                @error('longitude')
                                <small class="form-text text-muted">
                                    {{ $message }}
                                </small>
                            ...
                            <div class="form-group @error('jarak_maks') has-error @enderror">
                                ...
                                <input type="text" class="form-control" name="jarak_maks" value="{{ old('jarak_maks', $kantor->jarak_maks) }}"/>
                                @error('jarak_maks')
                                <small class="form-text text-muted">
                                    {{ $message }}
                                </small>
