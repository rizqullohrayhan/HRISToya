...
<div class="container">
    <div class="page-inner">
        <div class="page-header">
            <h4 class="page-title">Pengajuan Surat Ijin</h4>
        </div>
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex align-items-center">
                            <h4 class="card-title">List Pengajuan Surat Ijin</h4>
                            @can('add surat ijin')
                            <a href="{{ route('ijin.create') }}" class="btn btn-primary ms-auto">
...
<script>
    window.Laravel = {
        dataUrl: "{{ route('ijin.data') }}",
        deleteUrl: '{{ route("ijin.destroy", ["ijin" => "__ID__"]) }}'
    };
</script>
<script src="{{ asset('custom/suratijin/index.js') }}"></script>
