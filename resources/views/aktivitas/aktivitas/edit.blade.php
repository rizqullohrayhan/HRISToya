            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-category">Edit aktivitas</div>
                    </div>
                    <div class="card-body">
                        <form class="row" id="add-form" action="{{ route('aktivitas.update', $aktivitas->id) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                <div class="form-group @error('tanggal') has-error @enderror">
                                    ...
                                    <input type="text" class="form-control" id="tanggal" name="tanggal"
                                            value="{{ old('tanggal', \Carbon\Carbon::createFromFormat('Y-m-d', $aktivitas->tanggal)->format('d/m/Y')) }}"
                                    >
                                    @error('tanggal')
                                    <small class="form-text text-muted">
                                        {{ $message }}
                                    ...
                                    <select name="jam_awal" id="jam_awal" class="form-select">
                                        @for ($hour = 0; $hour < 24; $hour++)
                                            @for ($minute = 0; $minute < 60; $minute += 30)
                                                <option value="{{ sprintf('%02d:%02d', $hour, $minute) }}" @selected(sprintf('%02d:%02d', $hour, $minute) == old('jam_awal', $aktivitas->jam_awal))>
                            ...
                            <div class="col-md-6">
                                <div class="form-group @error('jam_akhir') has-error @enderror">
                                    ...
                                    <select name="jam_akhir" id="jam_akhir" class="form-select">
                                        @for ($hour = 0; $hour < 24; $hour++)
                                            @for ($minute = 0; $minute < 60; $minute += 30)
                                                <option value="{{ sprintf('%02d:%02d', $hour, $minute) }}" @selected(sprintf('%02d:%02d', $hour, $minute) == old('jam_akhir', $aktivitas->jam_akhir))>
                                                    {{ sprintf('%02d:%02d', $hour, $minute) }}
                                                </option>
                                            @endfor
                                        @endfor
                            ...
                            <div class="col-md-12">
                                <div class="form-group @error('rencana') has-error @enderror">
                                    ...
                                    <input type="text" class="form-control" name="rencana" value="{{ old('rencana', $aktivitas->rencana) }}">
                                    @error('rencana')
                                    <small class="form-text text-muted">
                                        {{ $message }}
                                    </small>
                            ...
                            <div class="col-md-12">
                                <div class="form-group @error('aktivitas') has-error @enderror">
                                    ...
                                    <textarea class="form-control" name="aktivitas" id="aktivitas" rows="5">{{ old('aktivitas', $aktivitas->aktivitas) }}</textarea>
                                    @error('aktivitas')
                                    <small class="form-text text-muted">
                                        {{ $message }}
                                    </small>
                            ...
                            <div class="col-md-12">
                                <div class="form-group @error('hasil') has-error @enderror">
                                    ...
                                    <textarea class="form-control" name="hasil" id="hasil" rows="5">{{ old('hasil', $aktivitas->hasil) }}</textarea>
                                    @error('hasil')
                                    <small class="form-text text-muted">
                                        {{ $message }}
                                    </small>
                            ...
                            <div class="col-md-12">
                                <div class="form-group @error('rekan_id') has-error @enderror">
                                    ...
                                    <select name="rekan_id" id="rekan_id" class="form-select">
                                        ...
                                        <option value="{{ $rekan->id }}" @selected($rekan->id == old('rekan_id', $aktivitas->rekan_id))>
                            ...
                            <div class="col-md-12">
                                <div class="form-group @error('tipe_id') has-error @enderror">
                                    ...
                                    <select name="tipe_id" id="tipe_id" class="form-select">
                                        ...
                                        <option value="{{ $tipe->id }}" @selected($tipe->id == old('tipe_id', $aktivitas->tipe_id))>
                                            {{ $tipe->name }}
                                        </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-12">
                                <div class="form-group @error('cara_id') has-error @enderror">
                                    ...
                                    <select name="cara_id" id="cara_id" class="form-select">
                                        ...
                                        <option value="{{ $cara->id }}" @selected($cara->id == old('cara_id', $aktivitas->cara_id))>
                                            {{ $cara->name }}
                                        </option>
                                        @endforeach
                                    </select>
