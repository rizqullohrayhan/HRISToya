        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('kodeperkiraan.update', $kodePerkiraan->id) }}" method="post">
                            @csrf
                            @method('PUT')
                            <div class="form-group @error('code') has-error @enderror">
                                <label for="code">Kode Perkiraan</label>
                                <input type="text" class="form-control" name="code" value="{{ old('code', $kodePerkiraan->code) }}"/>
                                @error('code')
                            ...
                            <div class="form-group @error('name') has-error @enderror">
                                ...
                                <input type="text" class="form-control" name="name" value="{{ old('name', $kodePerkiraan->name) }}"/>
                                @error('name')
                                <small class="form-text text-muted">
                                    {{ $message }}
                                </small>
