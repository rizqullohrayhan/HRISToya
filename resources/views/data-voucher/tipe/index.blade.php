                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex align-items-center">
                            <h4 class="card-title">List Tipe Voucher</h4>
                            @can('add tipe voucher')
                            <a href="{{ route('tipevoucher.create') }}" class="btn btn-primary ms-auto">
                                            ...
                                            <div class="form-button-action">
                                                <div class="btn-group dropdown">
                                                    ...
                                                    <ul class="dropdown-menu" role="menu">
                                                        <li>
                                                            @can('edit tipe voucher')
                                                            <a href="{{ route('tipevoucher.edit', $tipe->id) }}" title="Edit" class="btn btn-link btn-warning" data-original-title="Edit">
                                                                <i class="fa fa-edit"></i>&nbsp;Edit
                                                            </a>
                                                            @endcan
                                                            @can('delete tipe voucher')
...
<script>
    $('#table-datatable').on('click', '.btn-destroy', function(){
        swal({
            ...
            if (willDelete) {
                let id = $(this).data("id");
                let url = '{{ route("tipevoucher.destroy", ["tipevoucher" => "__ID__"]) }}';
