...
<div class="container">
    <div class="page-inner">
        <div class="page-header">
            <h4 class="page-title">Edit Ajuan Cuti</h4>
        </div>
        <form id="add-form" action="{{ route('cuti.update', $surat->id) }}" method="post" autocomplete="off">
            @csrf
            @method('PUT')
            <div class="row">
                <div class="col-md-12">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group @error('periode') has-error @enderror">
                                        ...
                                        <input type="number" class="form-control" name="periode" id="periode" value="{{ old('periode', $surat->periode) }}">
                                        @error('periode')
                                        <small class="form-text text-muted text-danger">
                                            {{ $message }}
                                        </small>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group @error('macam_id') has-error @enderror">
                                        ...
                                        <select name="macam_id" id="macam_id" class="form-select form-control select2">
                                            ...
                                            <option value="{{ $macam->id }}" @selected($macam->id == old('macam_id', $surat->macam_id))>
                                                {{ $macam->name }}
                                            </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group @error('jatah_cuti') has-error @enderror">
                                        ...
                                        <input type="number" class="form-control" min="0" name="jatah_cuti" id="jatah_cuti" value="{{ old('jatah_cuti', $surat->jatah_cuti) }}">
                                        @error('jatah_cuti')
                                        <small class="form-text text-muted text-danger">
                                            {{ $message }}
                                        </small>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group @error('cuti_bersama') has-error @enderror">
                                        ...
                                        <input type="number" class="form-control" min="0" name="cuti_bersama" id="cuti_bersama" value="{{ old('cuti_bersama', $surat->cuti_bersama) }}">
                                        @error('cuti_bersama')
                                        <small class="form-text text-muted text-danger">
                                            {{ $message }}
                                        </small>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group @error('cuti_diambil') has-error @enderror">
                                        ...
                                        <input type="number" class="form-control" min="0" name="cuti_diambil" id="cuti_diambil" value="{{ old('cuti_diambil', $surat->cuti_diambil) }}">
                                        @error('cuti_diambil')
                                        <small class="form-text text-muted text-danger">
                                            {{ $message }}
                                        </small>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group @error('cuti_sanksi') has-error @enderror">
                                        ...
                                        <input type="number" class="form-control" min="0" name="cuti_sanksi" id="cuti_sanksi" value="{{ old('cuti_sanksi', $surat->cuti_sanksi) }}">
                                        @error('cuti_sanksi')
                                        <small class="form-text text-muted text-danger">
                                            {{ $message }}
                                        </small>
