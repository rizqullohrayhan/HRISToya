                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex align-items-center">
                            <h4 class="card-title">List Dinas Luar</h4>
                            @can('add dinas luar')
                            <a href="{{ route('dinasluar.create') }}" class="btn btn-primary ms-auto">
...
<script>
    window.Laravel = {
        dataUrl: "{{ route('dinasluar.data') }}",
        deleteUrl: '{{ route("dinasluar.destroy", ["dinasluar" => "__ID__"]) }}'
    };
</script>
<script src="{{ asset('custom/dinasluar/index.js') }}"></script>
