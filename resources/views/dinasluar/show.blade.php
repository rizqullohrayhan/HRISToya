...
<div class="container">
    <div class="page-inner">
        <div class="page-header">
            <h4 class="page-title">Detail Dinas Luar</h4>
        </div>
        <div class="row">
            <div class="col-md-8">
                <div class="row">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="card-title">
                                    Form Dinas Luar {{ $surat->no_surat }}
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="row">
                                            ...
                                            <div class="col-md-8 col-7">
                                                <span>: {{ $surat->tipe_kendaraan }}</span>
                                            </div>
                                            <div class="col-md-4 col-5">
                                            ...
                                            <div class="col-md-8 col-7">
                                                <span>: {{ \Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $surat->berangkat)->locale('id')->isoFormat('dddd, D MMMM YYYY H:mm') }}</span>
                                            </div>
                                            <div class="col-md-4 col-5">
                                                <span class="fw-bold">Kembali</span>
                                            </div>
                                            <div class="col-md-8 col-7">
                                                <span>: {{ \Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $surat->kembali)->locale('id')->isoFormat('dddd, D MMMM YYYY H:mm') }}</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="row">
                                            <div class="col-md-4 col-5">
                                                <span class="fw-bold">Instansi Tujuan</span>
                                            </div>
                                            <div class="col-md-8 col-7">
                                                <span>: {{ $surat->instansi }}</span>
                                            </div>
                                            <div class="col-md-4 col-5">
                                                <span class="fw-bold">Nama Pejabat</span>
                                            </div>
                                            <div class="col-md-8 col-7">
                                                <span>: {{ $surat->nama_pejabat }}</span>
                                            </div>
                                            <div class="col-md-4 col-5">
                                            ...
                                            <div class="col-md-8 col-7">
                                                <span>: {{ $surat->no_telp }}</span>
                                            </div>
                                            <div class="col-md-4 col-5">
                                                <span class="fw-bold">Tujuan Dinas</span>
                                            </div>
                                            <div class="col-md-8 col-7">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex flex-wrap gap-2 justify-content-start">
                            @if ($ruleUser && ($surat->diperiksa == null || auth()->user()->hasRole('ADM')))
                                <a href="{{ route('dinasluar.edit', $surat->id) }}" class="btn btn-warning">Edit</a>
                            @endif
                            ...
                            @if ($surat->disetujui && (auth()->user()->id == $surat->dibuat_id || auth()->user()->hasRole('ADM')))
                                <a href="{{ route('dinasluar.cetak', $surat->id) }}" target="_blank" class="btn btn-info">Cetak</a>
                            @endif

                            <a href="{{ route('dinasluar.index') }}" class="btn btn-danger">Kembali</a>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    window.Laravel = {
        otorisasiUrl: "{{ route('dinasluar.update.otoritas', $surat->id) }}",
        closeUrl: "{{ route('dinasluar.close', $surat->id) }}"
    };
    const url = "{{ route('dinasluar.show', $surat->id) }}";
