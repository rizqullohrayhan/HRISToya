...
<body>
    <table class="full-border">
        <thead>
            ...
            <tr>
                <td class="full-border">No Risalah : {{ $surat->no_surat }}</td>
                <td class="full-border">Hari, Tangal</td>
                <td class="full-border">{{ $surat->tanggal ? \Carbon\Carbon::parse($surat->tanggal)->locale('id')->isoFormat('dddd, D MMMM YYYY') : '' }}</td>
            </tr>
            <tr>
                ...
                <td class="full-border">{{ $surat->tanggal ? \Carbon\Carbon::parse($surat->tanggal)->format('H.i') : '' }}</td>
            </tr>
            <tr>
                <td class="full-border">Unit Kerja</td>
                <td class="full-border">{{ $surat->unit_kerja }}</td>
            </tr>
            <tr>
                <td class="full-border">Pimpinan Rapat</td>
                <td class="full-border">{{ $surat->pimpinan }}</td>
            </tr>
            <tr>
        ...
        <tbody>
            ...
            @if ($daftarHadir->isEmpty())
                <tr>
                    <td colspan="5" class="text-center">Tidak ada daftar hadir</td>
                </tr>
            @else
