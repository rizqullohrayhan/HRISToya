...
<div class="container">
    <div class="page-inner">
        ...
        <form id="add-form" action="{{ route('dinasluarkota.update', $surat->id) }}" method="post" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="row">
                {{-- Dinas Luar Kota --}}
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group @error('berangkat') has-error @enderror">
                                        ...
                                        <input type="text" class="form-control flatpicker @error('berangkat') is-invalid @enderror" id="berangkat" name="berangkat" value="{{ old('berangkat', $surat->berangkat ? \Carbon\Carbon::parse($surat->berangkat)->format('d/m/Y') : '') }}" readonly>
                                        @error('berangkat')
                                        <small class="form-text text-muted text-danger">
                                            {{ $message }}
                                        </small>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group @error('kota') has-error @enderror">
                                        ...
                                        <input type="text" class="form-control" name="kota" id="kota" value="{{ old('kota', $surat->kota) }}">
                                        @error('kota')
                                        <small class="form-text text-muted text-danger">
                                            {{ $message }}
                                        </small>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group @error('jangka_waktu') has-error @enderror">
                                        ...
                                        <div class="input-group">
                                            <input type="number" class="form-control" name="jangka_waktu" id="jangka_waktu" value="{{ old('jangka_waktu', $surat->jangka_waktu) }}">
                                            <select name="satuan_waktu" id="satuan_waktu">
                                                <option value="Hari" @selected("Hari" == old('satuan_waktu', $surat->satuan_waktu))>Hari</option>
                                                <option value="Minggu" @selected("Minggu" == old('satuan_waktu', $surat->satuan_waktu))>Minggu</option>
                                                <option value="Bulan" @selected("Bulan" == old('satuan_waktu', $surat->satuan_waktu))>Bulan</option>
                                                <option value="Tahun" @selected("Tahun" == old('satuan_waktu', $surat->satuan_waktu))>Tahun</option>
                                            </select>
                                        </div>
                                        @error('jangka_waktu')
                                        <small class="form-text text-muted text-danger">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        @endforeach
                                        <div id="tabel-detail">
                                            @php $details = old('detail', $surat->detail); @endphp
                                            @foreach ($details as $index => $detail)
                                                <div class="row row-detail mb-3">
                                                    ...
                                                    <div class="col-xxl-4 col-md-6 mb-4">
                                                        ...
                                                        <input type="name" class="form-control" name="details[{{ $index }}][instansi]" id="details_{{ $index }}_instansi" value="{{ old('details.'.$index.'.instansi', $detail['instansi'] ?? '') }}">
                                                    </div>

                                                    <div class="col-xxl-4 col-md-6 mb-4">
                                                        <label for="details_{{ $index }}_menemui" class="form-label">Menemui</label>
                                                        <input type="name" class="form-control" name="details[{{ $index }}][menemui]" id="details_{{ $index }}_menemui" value="{{ old('details.'.$index.'.menemui', $detail['menemui'] ?? '') }}">
                                                    </div>

                                                    <div class="col-xxl-4 col-md-6 mb-4">
                                                        <label for="details_{{ $index }}_tujuan" class="form-label">Tujuan</label>
                                                        <input type="text" class="form-control" name="details[{{ $index }}][tujuan]" id="details_{{ $index }}_tujuan" value="{{ old('details.'.$index.'.tujuan', $detail['tujuan'] ?? '') }}">
                                                    </div>
                                                </div>
                                            @endforeach
                                        </div>
