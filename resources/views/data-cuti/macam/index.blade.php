                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex align-items-center">
                            <h4 class="card-title">List Macam Cuti</h4>
                            @can('add macam cuti')
                            <a href="{{ route('macamcuti.create') }}" class="btn btn-primary ms-auto">
                                            ...
                                            <div class="form-button-action">
                                                <div class="btn-group dropdown">
                                                    ...
                                                    <ul class="dropdown-menu" role="menu">
                                                        <li>
                                                            @can('edit macam cuti')
                                                            <a href="{{ route('macamcuti.edit', $tipe->id) }}" title="Edit" class="btn btn-link btn-warning" data-original-title="Edit">
                                                                <i class="fa fa-edit"></i>&nbsp;Edit
                                                            </a>
                                                            @endcan
                                                            @can('delete macam cuti')
...
<script>
    $('#table-datatable').on('click', '.btn-destroy', function(){
        swal({
            ...
            if (willDelete) {
                let id = $(this).data("id");
                let url = '{{ route("macamcuti.destroy", ["macamcuti" => "__ID__"]) }}';
