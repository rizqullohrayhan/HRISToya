...
<div class="container">
    <div class="page-inner">
        <div class="page-header">
            <h4 class="page-title">Tambah Pengajuan Voucher</h4>
        </div>
        <form id="add-form" action="{{ route('voucher.store') }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group @error('status_id') has-error @enderror">
                                            ...
                                            <select name="status_id" id="status_id" class="form-select form-control">
                                                ...
                                                <option value="{{ $statu->id }}" @selected($statu->id == old('status_id'))>
                                                    {{ $statu->name }}
                                                </option>
                                                @endforeach
                                            </select>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group @error('bank_code_id') has-error @enderror">
                                            ...
                                            <select name="bank_code_id" id="bank_code_id" class="form-select form-control select2">
                                                <option value="">Pilih Bank</option>
                                                @foreach ($perkiraans as $perkiraan)
                                                <option value="{{ $perkiraan->id }}" @selected($perkiraan->id == old('bank_code_id'))>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group @error('rekan_id') has-error @enderror">
                                            ...
                                            <select name="rekan_id" id="rekan_id" class="form-select form-control select2">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group @error('pay_for') has-error @enderror">
                                            ...
                                            <input type="text" class="form-control" name="pay_for" id="pay_for" value="{{ old('pay_for') }}">
                                            @error('pay_for')
                                            <small class="form-text text-muted">
                                                {{ $message }}
                                            </small>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group @error('tipe_id') has-error @enderror">
                                            ...
                                            <select name="tipe_id" id="tipe_id" class="form-select form-control select2">
                                            ...
                                            <tr class="row-detail">
                                                ...
                                                <td class="td_kode_bank">
                                                    <select name="details[{{ $index }}][bank_code_id]" class="kode_bank select_detail" id="details[{{ $index }}][bank_code_id]">
                                                        ...
                                                        @foreach ($perkiraans as $perkiraan)
                                                        <option value="{{ $perkiraan->id }}" data-code="{{ $perkiraan->code }}" @selected($perkiraan->id == old("details.$index.bank_code_id", $detail['bank_code_id'] ?? ''))>
                                                            {{ $perkiraan->name }}
                                                        </option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <td class="td_kode_perkiraan">
                                                    <select name="details[{{ $index }}][code]" class="kode_perkiraan select_detail" id="details[{{ $index }}][code]">
                                                        <option value="" data-code="" data-name=""></option>
                                                        @foreach ($perkiraans as $perkiraan)
                                                        <option value="{{ $perkiraan->id }}" data-code="{{ $perkiraan->code }}" data-name="{{ $perkiraan->name }}" @selected($perkiraan->id == old("details.$index.code", $detail['code'] ?? ''))>
                                                            {{ $perkiraan->name }}
                                                        </option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <td>
                                                    <input type="text" name="details[{{ $index }}][name]" id="details[{{ $index }}][name]" value="{{ old('details.'.$index.'.name') }}" readonly>
                                                </td>
                                                ...
                                                <td>
                                                    <input type="text" class="input-number" name="details[{{ $index }}][amount]" id="details[{{ $index }}][amount]" value="{{ old('details.'.$index.'.amount') }}" placeholder="Jumlah" autocomplete="off"/>
                                                </td>
                                                <td>
                                                    <input type="text" name="details[{{ $index }}][uraian]" id="details[{{ $index }}][uraian]" value="{{ old('details.'.$index.'.uraian') }}" placeholder="Uraian"/>
                                                </td>
                                                <td>
                                                    <input type="text" name="details[{{ $index }}][no_bukti]" id="details[{{ $index }}][no_bukti]" value="{{ old('details.'.$index.'.no_bukti') }}" placeholder="No Bukti"/>
                                                </td>
                                                <td>
                                                    <input type="text" class="input-date" id="details[{{ $index }}][tgl_bukti]" name="details[{{ $index }}][tgl_bukti]" value="{{ old('details.'.$index.'.tgl_bukti') }}" readonly>
                                                </td>
                                                <td class="td_rekanan">
                                                ...
                                                <td>
                                                    <input type="text" name="details[{{ $index }}][name_rekan]" id="details[{{ $index }}][name_rekan]" value="{{ old('details.'.$index.'.name_rekan') }}" readonly>
                                                </td>
                                            </tr>
                                            @endforeach
                                        </tbody>
                                ...
                                <table id="otorisasi-table" class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button type="button" class="btn btn-secondary otorisasi-btn otorisasi-mode" data-target="pembukuan">
                                                    Otorisasi
                                                </button>
                                            </td>
                                            <td>
                                ...
                                <div class="col-md-3">
                                    <table id="otorisasi-table" class="table table-bordered pembukuan">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>
                                                    <button type="button" class="btn btn-secondary otorisasi-btn otorisasi-mode otorisasi-pembukuan" data-target="pembukuan" disabled>
                                                        Otorisasi
                                                    </button>
                                                </td>
                                            </tr>
