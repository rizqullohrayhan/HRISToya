            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-category">Edit user</div>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('user.update', $user->id) }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group @error('jabatan') has-error @enderror">
                                ...
                                <input type="text" class="form-control" name="jabatan" id="jabatan" value="{{ old('jabatan', $user->jabatan) }}"/>
                                @error('jabatan')
                                <small class="form-text text-muted">
                                    {{ $message }}
                                </small>
                            ...
                            <div class="form-group @error('role') has-error @enderror">
                                ...
                                <select class="form-select" name="role" id="role">
                                    @foreach ($roles as $role)
                                        <option value="{{$role->name}}" @selected($role->name == old('role', $user->roles[0]->name))>{{ $role->name }}</option>
                                    @endforeach
                                </select>
                                @error('role')
                                <small class="form-text text-muted">
                            ...
                            <div class="form-group @error('team') has-error @enderror">
                                ...
                                <select class="form-select" name="team" id="team">
                                    @foreach ($teams as $team)
                                        <option value="{{$team->id}}" @selected($team->id == old('team', $user->team_id))>{{ $team->name }}</option>
                                    @endforeach
                                </select>
                                @error('team')
                                <small class="form-text text-muted">
                            ...
                            <div class="form-group @error('kantor') has-error @enderror">
                                ...
                                <select class="form-select" name="kantor" id="kantor">
                                    @foreach ($kantors as $kantor)
                                        <option value="{{$kantor->id}}" @selected($kantor->id == old('kantor', $user->kantor_id))>{{ $kantor->name }}</option>
                                    @endforeach
                                </select>
                                @error('kantor')
                                <small class="form-text text-muted">
                            ...
                            <div class="form-group @error('picture') has-error @enderror">
                                ...
                                <input id="picture" type="file" class="form-control-file" name="picture" accept="image/*">
                                @error('picture')
                                <small class="form-text text-muted">
                                    {{ $message }}
                                </small>
                            ...
                            <div class="form-group @error('password') has-error @enderror">
                                ...
                                <small class="form-text text-muted">
                                    Kosongkan jika tidak ganti password
                                </small>
                                @error('password')
                                <small class="form-text text-muted">
                                    {{ $message }}
