                                            ...
                                            <div class="form-button-action">
                                                <div class="btn-group dropdown">
                                                    ...
                                                    <ul class="dropdown-menu" role="menu">
                                                        <li>
                                                            @can('edit permission')
                                                            <a href="{{ route('permission.edit', $permission->id) }}" title="Edit" class="btn btn-link btn-primary" data-original-title="Edit">
                                                                <i class="fa fa-edit"></i>&nbsp;Edit
                                                            </a>
                                                            @endcan
                                                            @can('delete permission')
                                                            <button type="button" data-id="{{ $permission->id }}" title="Hapus permission" class="btn btn-link btn-danger btn-destroy" data-original-title="Remove">
...
<script>
    $('#table-datatable').on('click', '.btn-destroy', function(){
        swal({
            ...
            if (willDelete) {
                let id = $(this).data("id");
                let url = '{{ route("permission.destroy", ["permission" => "__ID__"]) }}';
